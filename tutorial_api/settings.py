...
SECRET_KEY = 'django-insecure-v&*$_4zwrg!4g(nro36o$=*7=ao-+!@27pl6x^b%^+sc7sgox('
...
# Configuración de DRF para usar Spectacular
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # Para autenticación por Tokens (JWT)
        'rest_framework_simplejwt.authentication.JWTAuthentication',
        # Para mantener la sesión en el navegador (admin y browsable API)
